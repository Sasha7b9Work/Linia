...
enum
{
    ...
    ID_MENU_ARCHIVE_CLEAR,
    ID_MENU_ARCHIVE_DELETE_FROM,
    ID_MENU_ARCHIVE_LOAD_FROM,
    ID_MENU_ARCHIVE_OPEN,
    ...
    ID_GRID_BUTTON_HELP,
    ID_GRID_BUTTON_X_LESS,
    ID_GRID_BUTTON_X_MORE,
    ID_GRID_BUTTON_Y_LESS,
    ID_GRID_BUTTON_Y_MORE
};
