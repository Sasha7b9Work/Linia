...
enum
{
    ...
    ID_OFFSET_RB_CHAN_C_MEAS_I,
    ID_OFFSET_RB_CHAN_C_MEAS_U,
    ID_OFFSET_RB_CHAN_B_MEAS_I,
    ID_OFFSET_RB_CHAN_B_MEAS_U,
    ID_OFFSET_RB_CHAN_B_SOURCE_I,
    ID_OFFSET_RB_CHAN_B_SOURCE_U,
    ID_OFFSET_RB_CHAN_B_LIMIT_I,
    ID_OFFSET_RB_CHAN_B_LIMIT_U,
    ID_OFFSET_RB_CHAN_S_MEAS_I,
    ID_OFFSET_RB_CHAN_S_MEAS_U,
    ID_OFFSET_RB_CHAN_S_SOURCE_I,
    ID_OFFSET_RB_CHAN_S_SOURCE_U,
    ID_OFFSET_RB_CHAN_S_LIMIT_I,
    ID_OFFSET_RB_CHAN_S_LIMIT_U,
    ID_OFFSET_BTN_APPLY,
