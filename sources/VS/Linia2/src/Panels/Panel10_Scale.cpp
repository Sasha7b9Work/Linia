        ...
        MainWindow::WIDTH3, MainWindow::HEIGHT - PanelConfig::HEIGHT - PanelIndicator::HEIGHT)
{
    ...
    wxToggleButton *button = new wxToggleButton(this, ID_PAN10_BTN_SCALE, _L("Ўкала"), { 0, 0 }, { 60, 20 });
    str_panels.push_back({ button, nullptr });

    button = new wxToggleButton(this, ID_PAN10_BTN_ERRORS, _L("ќшибки"), { 60, 0 }, { 60, 20 });
    str_panels.push_back({ button, nullptr });
