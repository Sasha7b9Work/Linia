...
4. **Отключение GSpell**: Библиотека проверки орфографии отключена для уменьшения зависимостей
5. **Улучшенный поиск библиотек**: Используется find_library() с fallback на архитектурно-специфичные пути
6. **WebKit2GTK совместимость**: Автоматическое определение версии WebKit2GTK для Ubuntu 24.04 (4.1) и старших версий (4.0)
...
- Отключена библиотека GSpell для уменьшения зависимостей
