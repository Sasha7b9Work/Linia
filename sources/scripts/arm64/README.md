...
Данная директория содержит скрипты для сборки проекта Linia на одноплатном компьютере Orange Pi 5 Plus с процессором RK3588 (ARM64) под управлением Ubuntu 24.04 и XFCE.
