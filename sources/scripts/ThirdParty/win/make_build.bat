...
cmake.exe ../..\..\ThirdParty\wxWidgets\CMakeLists.txt -B..\..\../generated\ThirdParty -G "Visual Studio 18 2026" -A Win32 -DwxBUILD_STRIPPED_RELEASE=ON -DwxBUILD_SHARED=OFF -DwxBUILD_USE_STATIC_RUNTIME=ON -DwxBUILD_SAMPLES=OFF
