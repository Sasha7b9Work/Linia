// 2025/10/15 16:05:06 (c) Aleksandr Shevchenko e-mail : Sasha7b9@gmail.com
#pragma once
...
struct ChipDAC : public Chip
{
    enum E
    {
        CHAN_C_OPi5Plus,     // Динамический ЦАП - в него могут засылаться значения во время измерения. Доступен только с OPi5Plus
        CHAN_C_RANGE,
        CHAN_B_1,
        CHAN_B_2,
        CHAN_S_1,
        CHAN_S_2,
        SOURCE_50V_OPi5Plus, // Динамический ЦАП - в него могут засылаться значения во время проведения измерения. Доступен только с OPi5Plus
        Count
    };
