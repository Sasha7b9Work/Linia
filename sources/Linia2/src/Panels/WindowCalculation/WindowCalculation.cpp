...
void WindowCalculation::SetupDragging(wxWindow *window)
{
...
void WindowCalculation::OnDragStart(wxMouseEvent &event)
{
    if (!dragging)
    {
...
void WindowCalculation::OnDragEnd(wxMouseEvent &event)
{
    if (dragging)
    {
        wxWindow *source = (wxWindow *)event.GetEventObject();
...
void WindowCalculation::OnDragMotion(wxMouseEvent &event)
{
    wxWindow *source = (wxWindow *)event.GetEventObject();
