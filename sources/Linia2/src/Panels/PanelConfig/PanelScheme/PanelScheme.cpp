    ...
    wxPanel(parent)
{
...

    {
        ...
        btnLoad = new wxButton(boxTest, wxID_ANY, wxT("Загрузить"), { PanelConfig::X, SD::Y_SB(50) }, { 100, 30 });
...

    {
        ...
        comboCommutation = new ButtonsCombo(boxCommutation, wxT("Тип"), { SD::XY0() }, PanelConfig::WIDTH_COMBO, choices, choices, 1, "comboCommutation");
