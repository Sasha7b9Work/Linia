    ...
    PageChip(parent, "ПЛИС")
{
...

    {
        ...
        commandsScan.emplace_back(StructDescription::CommandStruct{ 0b0000, _("Выключена")});
        ...
        desc0.emplace_back(StructDescription{ 0, 4, _("разв"), _("развёртка"), { true, commandsScan } });

        std::vector<StructDescription::CommandStruct> commandsTypeElem; //-V826
        commandsTypeElem.emplace_back(StructDescription::CommandStruct{ 0, _("Диод") });
        commandsTypeElem.emplace_back(StructDescription::CommandStruct{ 1, _("Транзистор") });
        desc0.emplace_back(StructDescription{ 4, 1, "з", _("запуск"), { true, commandsTypeElem } });
        ...
        desc0.emplace_back(StructDescription{ 5, 4, _("к"), _("количество кривых ВАХ для DC+, DC-"), { true, commandsCurvers } });
