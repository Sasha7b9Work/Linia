    ...
    PageChip(parent, _("Канал C"))
{
    ...
    {
        RegFPGA *fpga2 = new RegFPGA(this, regs[2]);

        std::vector<StructDescription> desc0;

        std::vector<StructDescription::CommandStruct> commandQ2;
        commandQ2.emplace_back(StructDescription::CommandStruct{ 0b0, _("x 20 вкл") });
        commandQ2.emplace_back(StructDescription::CommandStruct{ 0b1, _("x 20 выкл") });
        desc0.emplace_back(StructDescription{ 2, 1, "Q2", "x20", {false, commandQ2} });

        std::vector<StructDescription::CommandStruct> commandQ3;
        commandQ3.emplace_back(StructDescription::CommandStruct{ 0b0, _("x 5 вкл") });
        commandQ3.emplace_back(StructDescription::CommandStruct{ 0b1, _("x 5 выкл") });
        desc0.emplace_back(StructDescription{ 3, 1, "Q3", "x5", {false, commandQ3} });

        std::vector<StructDescription::CommandStruct> commandQ4;
        commandQ4.emplace_back(StructDescription::CommandStruct{ 0b0, _("x 1 вкл") });
        commandQ4.emplace_back(StructDescription::CommandStruct{ 0b1, _("x 1 выкл") });
        desc0.emplace_back(StructDescription{ 4, 1, "Q4", "x1", {false, commandQ4} });

        std::vector<StructDescription::CommandStruct> commandQ5;
        commandQ5.emplace_back(StructDescription::CommandStruct{ 0b0, _(": 5 вкл") });
        commandQ5.emplace_back(StructDescription::CommandStruct{ 0b1, _(": 5 выкл") });
        desc0.emplace_back(StructDescription{ 5, 1, "Q5", ":5", {false, commandQ5} });

        std::vector<StructDescription::CommandStruct> commandQ6;
        commandQ6.emplace_back(StructDescription::CommandStruct{ 0b0, _(": 1.25 вкл") });
        commandQ6.emplace_back(StructDescription::CommandStruct{ 0b1, _(": 1.25 выкл") });
        desc0.emplace_back(StructDescription{ 6, 1, "Q6", ":1.25", {false, commandQ6} });

        std::vector<StructDescription::CommandStruct> commandQ7;
        commandQ7.emplace_back(StructDescription::CommandStruct{ 0b0, _(": 250 вкл") });
        commandQ7.emplace_back(StructDescription::CommandStruct{ 0b1, _(": 250 выкл") });
