// 2025/7/14 17:22:25 (c) Aleksandr Shevchenko e-mail : Sasha7b9@gmail.com
#include "defines.h"
...
{
    PageMeasures::self->gc->SetBrush(color);
    PageMeasures::self->gc->SetPen(color);
