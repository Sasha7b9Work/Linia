...
#include "defines.h"
#include "GUI/PanelMeasures/MenuDisplay.h"
...
#include "GUI/PanelMeasures/Graphics/GraphMeasure.h"
...
MenuDisplay::MenuDisplay() : wxMenu()
{
    ...
    Check(item->GetId(), PanelMeasures::self->full_screen);
    ...
    auto SetColor = [](const wxString &title, wxColour &color) -> bool
        {
            ...
            wxColourDialog dialog(PanelMeasures::self, &colourData);
...
{
    for (auto elem : PanelMeasures::self->entities)
    {
