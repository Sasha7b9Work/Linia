// 2025/10/07 11:51:53 (c) Aleksandr Shevchenko e-mail : Sasha7b9@gmail.com
#include "defines.h"
...
PageChannelForm::PageChannelForm(wxNotebook *notebook) :
    PageChip(notebook, L("Формирователь"))
{
    self = this;
