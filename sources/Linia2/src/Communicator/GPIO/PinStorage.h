...
public:
    enum E
    {
        ...
        _01_33V,
        _02_5V,
        T13_03,         // Этот пин, судя по gpio readall, не может использоваться в качестве GPIO. UART не работает, если его инициализировать
        _04_5V,
        T14_05,         // Этот пин, судя по gpio readall, не может использоваться в качестве GPIO. UART не работает, если его инициализировать
        _06_GND,
        T15_07,         // Этот пин, судя по gpio readall, не может использоваться в качестве GPIO. UART не работает, если его инициализировать
        _08_UART6_TX_M1,
        _09_GND,
        _10_UART6_RX_M1,
        ENC_A_11,
